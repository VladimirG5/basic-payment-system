...
/**
 * Same paths/contract as gateway-service's original AuthController - gateway now proxies
 * /api/v1/auth/* here instead of handling it directly (see gateway's AuthProxyController).
 */
@RestController
